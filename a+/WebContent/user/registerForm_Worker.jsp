		  ...
		  <tr height="40">
			...
			<td width="250" bgcolor="ffffff" style="padding-left: 10">
				<select name="income">
				    ...
				    <option value="level0">2000미만</option>
				    <option value="level1">2000이상~2500미만</option>
				    <option value="level2">2500이상~3000미만</option>
				    <option value="level3">3000이상~3500미만</option>
				    <option value="level4">3500이상~4000미만</option>
				    <option value="level5">4000이상~4500미만</option>
				    <option value="level6">4500이상~5000미만</option>
