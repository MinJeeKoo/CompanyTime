...
public class InfoDTO {
	   ...
	   public InfoDTO(int iNo, int pId, int wId, int cfdNo, int annual_Income, int InfoMood, int jobSat_R, String jobSat_H, int cafeteria,
			int trafficConven, String empWellfare) {
		this.iNo = iNo;
		this.pId = pId;
		this.wId = wId;
		this.cfdNo = cfdNo;
