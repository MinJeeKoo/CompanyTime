  ...
  <table style="width:100%">
	<tr>
	  ...
	  <td>
	    <table>
		  <tr>
			<td bgcolor="f4f4f4" height="22">&nbsp;&nbsp;<b> 로그인, 회원가입 </b>&nbsp;&nbsp;</td>
		  </tr>
	    </table>  
		...
		<input type="radio" name="user_type" value="w">현직자
		<input type="radio" name="user_type" value="pt">이직자
		<input type="radio" name="user_type" value="js">취준생
